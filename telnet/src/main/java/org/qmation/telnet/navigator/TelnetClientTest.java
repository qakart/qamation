package org.qmation.telnet.navigator;
/*
 ...
 ***/
public class TelnetClientTest implements Runnable, TelnetNotificationHandler
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        while (true)
        {
            ...
            try
            {
                ...
                Thread reader = new Thread (new TelnetClientTest());
                tc.registerNotifHandler(new TelnetClientTest());
